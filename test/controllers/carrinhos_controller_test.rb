...
class CarrinhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrinho" do
    assert_difference('Carrinho.count') do
      post carrinhos_url, params: { carrinho: { itens_id: @carrinho.itens_id, total: @carrinho.total } }
    end
  ...
  test "should update carrinho" do
    patch carrinho_url(@carrinho), params: { carrinho: { itens_id: @carrinho.itens_id, total: @carrinho.total } }
